...
import interactiveMapImg from '../images/interactive-map.png';

// import Layout from "../components/Layout"
import LayoutInstructions from '../components/layout-instructions';
...
const InstructionsPage = ({ data }) => {
  ...
  const renderNodeList = (node) => (
    <li key={node.id}>
      <AnchorLink to={'/instructions#' + node.id} title={node.text} />
  ...
  const hasInteractiveMap = datum.locations[0].interactivemaps.startingStop;
    ...
    <LayoutInstructions title={title} locations={locations}>
      <div className="intro">
        <div className="wrapper centered">
          <h1>
            Virtual Tour Installation <strong>Instructions</strong>
          </h1>
          <p>
                  ...
                  <ul className="embed_steps">
                    ...
                    <li>
                      ...
                      <PrismCode
                        code={`
<script>
    var yv_launch_success=true, yv_instid=${institutionID}, yv_locid=${firstLocation};
</script>
<script src="https://www.youvisit.com/tour/Success/js3"></script>
                      `}
                        language="html"
        ...
        <section className="available_add_ons">
          <div className="wrapper centered">
            <h2 id="available_add_ons" className="section-title">
              Available Add-Ons
            </h2>
            <div className="group">
              <header>
                <h3
                  id="self-guided-tours-and-your-website"
                  className="section-subtitle"
                >
                  <span className="anchor">
                    Self Guided Tours and Your Website
                  </span>
                </h3>
                <p>
                  Allow on campus visitors to explore trails and learn more
                  about points of interest with a GPS enabled mobile experience
                  that can be launched directly from your website. We recommend
                  linking from your “Visit Campus” page directly into your
                  interactive map for easy access to a self guided campus tour.
                </p>
                <div className="important_note">
                  To reduce drop off, ensure you follow the link out
                  instructions below:
                </div>
              </header>
              <div className="group_content">
                <div className="content">
                  <ol>
                    ...
                    <li>
                      Locate and hover over the Interactive Map at the bottom
                      left of your tour
                      <img src={interactiveMapImg} alt="Interactive Map" />
                    </li>
                    <li>Click “Interactive Map” button to launch map</li>
                    <li>In map view, click share at the bottom left</li>
                    <li>
                      Choose the for your direct link to the interactive map
                    </li>
                    <li>Copy link</li>
                  </ol>
                  <p>
                    Option 1: Use this exact link which will prompt a
                    registration form upon launch
                  </p>
                  <p>Option 2: Skip registration form by using this link:</p>
                  <PrismCode
                    code={`
https://youvis.it/EjL3jL?&wph=1&skipPrompt=1&actp=0
            ...
            <div className="group" id="have-additional-languages">
              <header>
                <h3 id="additional-languages" className="section-subtitle">
                  <span className="anchor">Have Additional Languages?</span>
                </h3>
                <p>
                  By adding a parameter to your existing embed code, you can
                  embed your virtual tour to launch directly into a specific
                  language.
                </p>
              </header>
              <div className="group_content">
